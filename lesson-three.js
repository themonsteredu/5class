...
export function lessonThree({step,source,btn}){
 ...
 const bodies=[
 `<div class="l3-observe">${lessonOneFigure(a.id)}<div><p>2차시 활동지 두 쪽에서 우리 질문의 답과 문장 검증 기록을 읽어 보세요.</p><h2>재료 · 특징 · 쓰임</h2><p>이미 확인한 항목에 표시하고, 더 알아볼 항목을 찾아봅시다.</p><p class="l3-note">지난 기록은 그대로 활용합니다. 남은 궁금증과 모르는 내용을 더 조사합니다.</p></div></div>`,
