...
rule(22,212,169)
heading(235,'03','조사 방법 정하기','우리 모둠의 질문을 해결할 방법을 하나 고르고, 조사할 내용을 써 봅시다.')
check(22,255,'교과서');check(78,255,'박물관 설명');check(142,255,'AI에게 질문하기')
text(22,268,'조사할 내용',9,color=muted);rule(22,279,169)
